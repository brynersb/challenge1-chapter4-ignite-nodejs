...
describe("Get Statement Operation", () => {
  ...
  it("should not be able to show a statement operation with nonexistent user", () => {
    expect(async () => {
      await getStatementOperationUseCase.execute({ user_id: "123", statement_id: "1234" })
  ...
  it("should not be able to show a statement operation with nonexistent statement", () => {
    expect(async () => {
      ...
      await getStatementOperationUseCase.execute({ user_id: userCreated.id as string, statement_id: "1234" })
